...
def load_data_and_labels():
    ...
    who_examples = list(open("/Users/rahulkumar/Desktop/m_classifier/corpus/qa_data.who", "r").readlines())
    who_examples = [s.strip() for s in who_examples]
    
    when_examples = list(open("/Users/rahulkumar/Desktop/m_classifier/corpus/qa_data.when", "r").readlines())
    when_examples = [s.strip() for s in when_examples]
    
    what_examples = list(open("/Users/rahulkumar/Desktop/m_classifier/corpus/qa_data.what", "r").readlines())
